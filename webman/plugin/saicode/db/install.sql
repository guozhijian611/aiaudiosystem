...
-- ----------------------------
INSERT INTO `sa_system_menu` VALUES (NULL, 0, '0', 'SAICODE', 'saicode', 'IconCode', 'saicode', NULL, NULL, 2, 1, 'M', 0, NULL, 1, 1, NULL, 1, 1, now(), now(), NULL);
SET @id := LAST_INSERT_ID();
SET @level := CONCAT('0', ',', @id);
INSERT INTO `sa_system_menu` VALUES (NULL, @id, @level, '代码生成', 'app/saicode/index', 'IconComputer', 'app/saicode/index', 'saicode/index', NULL, 2, 1, 'M', 0, NULL, 1, 0, NULL, 1, 1, now(), now(), NULL);